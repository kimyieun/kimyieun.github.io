...
![Validation](/assets/images/anovacode.PNG){:width="900px" height="400px"}{: .center}
...
f_oneway(*df_ind.groupby('factor')['X'].agg(list)) # * : argument unpacking 연산자로 iterable 데이터를 분해하여 함수 인자로 전달
